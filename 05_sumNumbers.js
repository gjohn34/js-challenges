...
function findSum(accumulator, currentValue) {
...
function findWinner(players) {
  ...
  playersCopy.forEach(function(player) {
    player.scores = player.scores.reduce(findSum)
  })
  return (playersCopy[0].scores >= playersCopy[1].scores) ? playersCopy[0].name : playersCopy[1].name
}
